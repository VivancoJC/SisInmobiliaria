...
public class VerificarCartController {
    ...
    public String viewCart(Model model, Principal principal) {
        ...
        VerificarCart shoppingCart = customer.getShoppingCart();

        model.addAttribute("shoppingCart", shoppingCart);

        return "/client/reservacion-cart";
    }
    ...
    public String emptyCart(Model model, Principal principal) {
        ...
        return "redirect:/reservacion-cart?emptyCart";
    }
    ...
    public String updateCart(
        ...
        return "redirect:/reservacion-cart?updateCart";
    }
    ...
    public String myAccountSave(@Valid
                                @ModelAttribute("shoppingCart") VerificarCart shoppingCart
            , Principal principal
        ...
        //Get full object
        VerificarCart shoppingCart1 = shoppingCartService.findById(shoppingCart.getId());
